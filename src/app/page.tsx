        ...
        <div className="mt-8 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/e/demo-family-thanksgiving"
              ...
              <span className="inline-block text-[11px] font-semibold text-accent-fg bg-blue-50 dark:bg-[#0D223A] px-2 py-0.5 rounded-full">Find a time</span>
            ...
            <Link href="/e/demo-emma-birthday"
              className="group block bg-surface rounded-2xl border border-hairline-soft p-4 hover:border-strong hover:shadow-sm transition-all active:scale-[0.99]">
              <span className="inline-block text-[11px] font-semibold text-social-fg bg-social-50 dark:bg-[#1C1939] px-2 py-0.5 rounded-full">RSVP</span>
