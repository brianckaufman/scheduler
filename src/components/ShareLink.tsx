    ...
    <div className="space-y-2">
      <div className="grid grid-cols-2 gap-2">
        <button
          ...
          className="py-2.5 px-4 text-sm font-medium rounded-xl border border-hairline text-body hover:bg-subtle transition-all duration-200 cursor-pointer flex items-center justify-center gap-2"
        >
          {copied ? (
            <>
        ...
        <button
          ...
          className="py-2.5 px-4 text-sm font-medium rounded-xl bg-social-500 text-white hover:bg-social-600 transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 active:scale-[0.97]"
        >
