...
export default function ShareLink({ event, isOrganizer }: ShareLinkProps) {
  ...
  const btnBase =
    'flex-1 min-w-0 py-2.5 px-3 text-sm font-medium rounded-xl transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 whitespace-nowrap';
    ...
    <div className="space-y-2">
      <div className="flex gap-2">
        ...
        <button
          ...
          className={`${btnBase} bg-social-500 text-white hover:bg-social-600 active:scale-[0.97]`}
        >
