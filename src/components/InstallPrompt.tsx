...
export default function InstallPrompt() {
  ...
  return (
    <div className="animate-fade-in mb-4 bg-subtle border border-hairline-soft rounded-2xl p-3.5 flex items-center gap-3">
      <div className="w-9 h-9 rounded-xl bg-surface shadow-sm flex items-center justify-center shrink-0">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-xs font-semibold text-heading">Add to Home Screen</p>
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        {deferredPrompt ? (
          <button
            ...
            className="px-3 py-1.5 bg-social-500 text-white text-xs font-semibold rounded-full hover:bg-social-600 transition-all active:scale-95 cursor-pointer"
          >
            Install
          </button>
        ) : null}
        <button
          type="button"
          onClick={dismiss}
          className="p-1 text-faint hover:text-secondary transition-colors cursor-pointer"
        >
