...
export default function InstallPrompt() {
  ...
  return (
    <div className="animate-fade-in mb-4 bg-gradient-to-r from-teal-50 to-blue-50 border border-teal-100 rounded-2xl p-3.5 flex items-center gap-3">
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        {deferredPrompt ? (
          <button
            ...
            className="px-3 py-1.5 bg-teal-500 text-white text-xs font-semibold rounded-full hover:bg-teal-600 transition-all active:scale-95 cursor-pointer"
          >
            Install
          </button>
        ) : null}
