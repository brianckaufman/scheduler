      ...
      <div className="space-y-3 animate-fade-in">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500 mt-0.5 leading-snug">Ask your group — everyone marks when they&apos;re free, then you pick the best time to gather.</p>
          </div>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500 mt-0.5 leading-snug">You already know the time. Set the date and invite people to gather.</p>
          </div>
